...
urlpatterns = [
    ...
    path('api/media/reorder/', views.api_reorder, name='api-reorder'),
    path('api/media/bulk-delete/', views.api_bulk_delete, name='api-bulk-delete'),
    ...
    path('api/user/', views.api_user_profile, name='api-user-profile'),
